    ...
    <div className="px-6 md:px-16 py-16 max-w-[1280px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center mb-16 md:mb-24">
        <div className="flex-1">
          ...
          <h1 className="font-heading font-semibold text-3xl md:text-[50px] text-text mb-6">{product.title}</h1>
        ...
        <div className="w-full md:w-[480px] h-[300px] md:h-[360px] bg-gradient-to-br from-accent/20 via-accent-bright/30 to-primary/20 rounded-2xl flex items-center justify-center">
          <div className="font-heading text-text/20 text-xl md:text-2xl">Map Visualization</div>
        </div>
      </div>

      {/* Features Section */}
      <div className="mb-16 md:mb-24">
        <h2 className="font-heading font-semibold text-2xl md:text-[40px] text-text mb-4">{product.title}</h2>
      ...
      {/* Pricing Teaser */}
      <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-6 md:p-12 text-center">
        <h2 className="font-heading font-semibold text-2xl md:text-[40px] text-text mb-4">Avoid surprise bills with fixed and transparent pricing</h2>
